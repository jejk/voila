...
<div class="artists form large-9 medium-8 columns content">
    ...
    <fieldset>
        ...
        //debug($demos->toArray());
            ...
            echo $this->Form->input('expiration', array('label' => "Date : ", 'type' => 'text', 
                                'class' => 'fl tal vat w300p', 'error' => false , 'id' => 'select_date')); 
			echo $this->Html->div('datepicker_img w100p fl pl460p pa', 
                            $this->Html->image('http://voila.local/debug_kit/img/cake.icon.png'),array('id' => 'datepicker_img'));
    ...
    <?php echo $this->Form->create(null, array('url'=>array('controller'=>'demos','action'=>'saveOrder'),'id'=>'dd-form')); ?>
