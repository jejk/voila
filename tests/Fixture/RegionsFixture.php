...
class RegionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'country_id' => ['type' => 'integer', 'length' => 3, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-05-17 14:55:08',
            'modified' => '2016-05-17 14:55:08'
        ],
    ];
}
